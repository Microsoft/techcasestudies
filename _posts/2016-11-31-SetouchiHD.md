...
- Solution overview: 
  ...
  ![Architecture]({{site.baseurl}}/images/2016-11-31-SetouchiHD/architecture.jpg?raw=true)
...
- Key technologies used:
  ...
  ![Hackfest Members]({{site.baseurl}}/images/2016-11-31-SetouchiHD/allmembers.jpg?raw=true)  
...
![Value Stream Mapping Discussion]({{site.baseurl}}/images/2016-11-31-SetouchiHD/VSMdiscussion.jpg?raw=true)  

![Value Stream Mapping Discussion]({{site.baseurl}}/images/2016-11-31-SetouchiHD/ValueStreamMapping.png?raw=true)  
...
![Swap deployment slots]({{site.baseurl}}/images/2016-11-31-SetouchiHD/deploymentslot.jpg?raw=true)  
...
Using this technique, you can avoid noizy neighbour problem. 
  ...
  ![App Service Plan]({{site.baseurl}}/images/2016-11-31-SetouchiHD/AppServicePlan.jpg?raw=true)
...
`Retain idefinitely` flag to keep the successfully deployed artifact. 
  ...
  ![Enable Retain idefinitely]({{site.baseurl}}/images/2016-11-31-SetouchiHD/RetainIndifinitely.jpg?raw=true)
...
```
  ...
  ![Personal Access Token]({{site.baseurl}}/images/2016-11-31-SetouchiHD/PersonalAccessToken.jpg?raw=true)
...
Finally, you can use Run Script task and run the bat file. If you use Linux or Mac for build machine, you can use same technique for shell script task.  
  ...
  ![Run Script]({{site.baseurl}}/images/2016-11-31-SetouchiHD/RunScript.jpg?raw=true)
...
build pipeline.
  ...
  ![Initial Build Pipeline]({{site.baseurl}}/images/2016-11-31-SetouchiHD/InitialBuildPipeline.png?raw=true)
...
However, the problem is the upload time. Especially ipa is very big. It took a long time to upload it. 
 ...
 the time is become within 14 second. 
  ...
  ![Improved Build Pipelline]({{site.baseurl}}/images/2016-11-31-SetouchiHD/ImprovedBuildPipeline.png?raw=true)
...
However, it is better solution for the ipa build. Because we already finish pod restore one the build definition. And we share it via drop folder. 
   ...
   ![iOS Release Pipeline]({{site.baseurl}}/images/2016-11-31-SetouchiHD/ReleaseiOS.jpg?raw=true)
